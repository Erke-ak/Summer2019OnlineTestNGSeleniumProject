...
public class WindowSwitching {
    ...
    public  void test1(){
        ...
        //after 3 seconds, another website will be opened, in the second wondow
    ...
    public void test2(){
        ...
        //also, you cannot easliy access anything frome there
        //there is no .get() method
        //that's why, we need to loop through the set, to read a data frome there
        //set can store only unique value
      Set<String> windowHandles =driver.getWindowHandles();
      //loop through the collection od window handles
