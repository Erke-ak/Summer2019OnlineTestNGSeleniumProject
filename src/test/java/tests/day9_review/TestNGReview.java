...
public class TestNGReview {
    ...
    //it helps to reduce code duplicattion
    ...
    //by default tests are running in alphabetic order(,b,c,d ... from the method name)
    ...
    @DataProvider(name = "testData") //this test will run twice,because we have 2 sets of data
    public static Object[][] testData() {
        return new Object[][]{{"http://www.apple.com", "Apple"}, //1st set of data
                {"http://google.com", "Google"}};  //2dn set of data
